...
public class Hide extends Route{

	public Hide(String path) {
		super(path);
	}
	...
	public Object handle(Request request, Response response) {
		...
		if(request.queryParams("id") == null) {
		 ...
		 String query = "UPDATE giveways SET enabled = 0 WHERE id = ?";
		...
		try {
			...
			response.redirect("/home?a=Can't Hide this Giveaway");
			e.printStackTrace();
		}
